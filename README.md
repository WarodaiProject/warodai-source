...
## 2.1 Язык словаря
Настоящий словарь является словарем **современного японского языка**. Однако, в отличии от традиционных бумажных словарей, он является *открытым* - в том числе, в смысле отсутствия у него фиксированной даты издания. Поскольку работа над словарем ведется постоянно, его авторы избавлены от необходимости четко обозначать временную границу, определяющую момент, на которой фиксируется лексические, грамматические, семантические и другие особенности языка, считающиеся его современным состоянием. Тем не менее, существует необходимость определить две условные временные точки, обозначающие: а) начало бытования языка, условно считающегося **современным** в нашем словаре; б) временную границу, относительно которой решается вопрос об устаревшей лексике, графике, орфографии и грамматике.
...
В качестве второй временной точки нами приняты первые послевоенные годы (1945-1950 гг.), в ходе которых бунго был окончательно вытеснен из официально-деловой сферы, были проведены реформы японской письменности, а благодаря стремительному восстановлению Японии после войны и бурному экономическому развитию, лексический состав языка стал с невиданной до того скоростью пополняться заимствованными словами.

Выбранные временные точки также не противоречат принципам определения границ бытования **современного японского языка**, предложенным авторами БЯРС, с оцифровки которого было начато создание настоящего словаря.

Указанные временные рамки не ограничивают лексический состав словаря строго. Они лишь задают общие приоритеты подбора лексического материала, выбора грамматических форм, значений, орфографии и т.п. Так, например, окуригана дается в словаре в соответствии с правилами присоединения окуриганы (送り仮名の付け方), установленными не ранее 1959 года. В словаре по большей части не фиксируются древние и старые формы глаголов и прилагательных, очень ограничено представлена лексика, вышедшая из употребления к началу эпохи Мэйдзи, считаются устаревшими слова, графика и орфография, вышедшие из употребления к первым послевоенным годам.

Таким образом, авторы настоящего словаря фокусируют свое внимание на состоянии литературного и разговорного японского языка в период с начала XX века и по настоящий момент, считая наиболее современным период с 1946 по настоящий момент.

## 2.2 Лексический состав словаря
Поскольку первоначальный словник настоящего словаря заимствован из БЯРС, то мы посчитали разумным при развитии словаря придерживаться основного принципа формирования лексического его состава, сформулированного авторами БЯРС в предисловии к первому изданию 1970 года:

    "Словарь наш не является всеобъемлющим словарем современного японского языка, т. е. не дает всех слов, в нем бытующих — в разных областях и на разных уровнях общественно-языковой практики. Словарь наш не претендует и на то, чтобы покрыть собою всю лексику того, что японцы называют «языком образцовым» или «стандартным» (хё:дзюнго), т. е. то, что мы называем литературным языком современной эпохи. В нашем словаре дана та лексика, которая входит в то, что именуют «общим языком», т. е. совокупностью тех слов, грамматических и стилистических форм и оборотов, которые являются общими для всех носителей данного языка, т. е. максимально распространенными в общественно-языковой практике нашего времени."

Далее в предисловии авторы БЯРС определяют "общий язык" как **язык массовой коммуникации**. Уточняя и дополняя понимание языка массовой коммуникации, предложенное авторами БЯРС, для целей настоящего словаря представляется целесообразным очертить следующие весьма условные границы, отделяющие этот язык от японского языка как совокупности **всех** бытующих в нем слов, письменных и речевых практик.

Под языком массовой коммуникации авторами настоящего словаря понимается язык бытующий прежде всего в:

а) общенацинальных средствах массовой информации - газетах, журналах, радиостанциях, телеканалах и их официальных интернет-сайтах;

б) авторитетных интернет-сайтах с высокой общенациональной посещаемостью;

в) авторитетных Youtube-каналах и подкастах с высоким числом подписчиков; 

г) в высокотиражных изданиях литературы - художественной, документальной, научно-публицистической, написанных не ранее эпохи Мэйдзи;

д) высокотиражных изданиях манга;

е) в художественных и документальных фильмах и анимэ, трансляция которых производится в крупных сетях кинотеатров, на международных кинофестивалях и на общенациональных телевизионных каналах;

ж) театральных постановках с участием известных труп и актеров (за исключением традиционных театров Кабуки, Но:, Дзё:рури и др.);

з) официальных документах, публикуемых государственными органами Японии, включая различные правительственные агентства, комитеты, суды, полицию и т.п.

и) официальных документах, публикуемых высокорейтинговыми средними и высшими учебными заведениями, общенациональными культурными заведениями - музеями, библиотеками и т.п.;

к) документах, публикуемых крупными частными структурами (корпорациями, ассоциациями и т.п.) включая пресс-релизы, маркетинговые материалы, отчеты, инструкции и т.п.;

л) материалах крупных общенациональных или международных конференций, симпозиумов, выставок, форумов, съездов, саммитов и т.п. 

Очерченные выше границы языка массовой коммуникации не являются строгими. В виду открытого характера настоящего словаря, включение в него слов и значений, находящихся за пределами этих границ, не является недопустимым. Оно является лишь менее вероятным.

Строгим критерием включения слова или значения в наш словарь является фиксация такового не менее чем в двух авторитетных толковых или двуязычных японских словарях.

Строгим критерием включения в словарь выражение является его нахождение хотя бы в одном авторитетном толковом или двуязычном японском словаре или не менее чем в двух разнородных источниках, относящихся к сферам бытования языка массовой коммуникации, перечисленных выше. Под разнородными в данном случае понимается источники, как можно более различающиеся по характеру информационного носителя и по признаку устности-письменности. Так, например, если выражение найдено в фильме, то оно подтверждено вторым источником, относящимся к письменной речи - художественной литературой, газетной статьей и т.п.

Одной из целей японских толковых словарей является стандартизация современного японского языка, т.е. распространение литературной нормы. В виду того, что настоящий словарь является двуязычным и предназначен прежде всего для носителей русского языка, он такой цели не имеет. Этим, в частности, объясняется фиксация в словаре наиболее распространенных ошибок с пометой `неправ.`. Настоящий словарь во многом стремится сохранять определенный баланс между фиксацией того, как должно быть, и того, как есть в языковой практике на самом деле.

## 2.3 Слово в словаре
Особенностью японских толковых словарей является то, что они, как правило, не дают многих производных слов, образованных такими форматами как *する*　или *たる*. Это и понятно, ведь толкование таких производных на японском было бы совершенно излишним при наличии толкования исходного слова. Напротив, в настоящем словаре, где вместо толкования дается перевод, наличие многочисленных производных оказываться оправданным. Русские переводы производных японских глаголов или прилагательных, образованных от существительных, далеко не всегда сводятся к автоматической замене номинативного значения глагольным или адъективным. 

Так, например, в словарях Ко:дзиэн изд-ва Иванами, Су:па: Дайдзирин изд-ва Сансэйдо: и Сэйсэнхан Нихон Кокуго Дзитэн изд-ва Сёгакукан не приведен отдельно глагол 忍辱する. При этом исходное существительное 忍辱, конечно, зафиксировано во всех трех словарях. В настоящем словаре слово 忍辱する дано как производное в статье 忍辱 с отдельным переводом: 

    にんにく【忍辱】(ниннику)〔003-31-58〕
    <i>кн.</i> терпеливость, стойкость;
    ～する стерпеть; проглотить <i>(обиду и т. п.)</i>.

Если бы в приведенной выше статье отсутсвовал отдельный перевод производного, пользователю словаря было бы сложно понять, что правильный перевод глагола - "стерпеть", а не, например, "терпеть" или "проявлять стойкость".

Аналогично в указанных японских словарях отсутствует, например, отдельное слово 蹣跚たる, в настоящем словаре же оно приведено в статье 蹣跚: 
...
Помимо уточнения перевода, приведение производных значительно облегчает обратный поиск по словарю, когда искомое слово приводится в виде русского глагола, прилагательного, причастия или целого словосочетания. Очевидно, что если бы в статье 蹣跚 не был бы дан перевод производного 蹣跚たる, пользователь не смог бы найти статью по таким словам как "шатающийся" или "нетвёрдый на ногах".  

Следуя основным принципам отбора словарного материала, сформулированного составителями БЯРС, настоящий словарь отличается в этом направлении и от наиболее авторитетных двуязычных японских словарей, таких, например, как Kenkyusha's New Japanese-English Dictionary изд-ва Кэнкю:ся. Он не дает в качестве отдельных словарных статей для большого количества сложных слов, перевод которых получается простым сложением переводов входящих в них компонентов, для которых в словаре даны отдельные статьи.

Так, например, в качестве отдельных словарных статей словарь Кэнкю:ся помещает слова 国際問題 и 国際会議. В нашем словаре этих сложных слов нет, поскольку 国際問題 легко переводится как "международный вопрос" или "международная проблема" с помощью статей `こくさい【国際】(кокўсай)〔008-95-81〕` и `もんだい【問題】(мондай)〔008-48-93〕`, а 国際会議 - как "международная конференция" с помощью статей `こくさい【国際】(кокўсай)〔008-95-81〕` и `かいぎ【会議】(кайги)〔004-22-46〕`.

Тот же подход используется в словаре для многочисленных наименований различных правительственных и международных организаций: комитетов, агентств, бюро и т.п. Так, словарь Кэнкю:ся дает более сотни словарных статей, оканчивающихся на ～員会 "комитет" или ～委員会, в то время, как наш словарь - лишь немногим больше двадцати. Например, отдельной словарной статьёй в словаре Кэнкю:ся дано 原子力安全委員会 "Комиссия по безопасности ядерной энергетики". В настоящем словаря такая статья отсутствует, поскольку перевод всего названия комисси можно легко получить с помощью статей `げんしりょく【原子力】(гэнсирёку)〔008-30-96〕`, `あんぜん【安全】(андзэн)〔002-37-77〕` и `いいんかい【委員会】(иинкай)〔005-82-04〕`.  

Отдельного пояснения требуют переводы названий видов, родов и семейств растений, рыб, птиц и животных. Для многих таких названий, являющихся в японском языке чисто бытовыми (ненаучными), отсутствуют русские эквиваленты. Из-за этого при переводе возникает путанница и неточности. Ярким примером такой путинницы является закрепившийся в русской переводческой традиции неверный перевод "барсук" для японского слова 狸, являющегося бытовым название енотовидной собаки Nyctereutes viverrinus *Temminck*. Во избежании подобных неточностей для каждого перевода названия видов, родов и семейств растений, рыб, птиц и животных в настоящем словаре обязательно приводится его латинское обозначение.  

## 2.4 Значения слова
В толковом словаре полное число значений, выделяемых для одного слова, определяется тем, сколько различных *толкований* может дать носитель данного языка для этого слова. В переводном же словаре число значений определяется числом *переводов*, которые могут быть сопоставлены этому слову носителем другого языка. Фундаментальное различие *толкования* и *перевода* обусловлено несовпадением *языковых картин мира*, сложившихся для разных языков. Так, одно толкование слова в языке *А* может соответствовать нескольким переводам на язык *Б* и - наоборот.

Настоящий словарь является словарем переводным. При разработке значений одного японского слова в нем используется следующая последовательность действий:
...
е) для каждого рубрики формулируются синонимичные и близкие по значению переводы, подбираются производные, свободные словосочетания и выражения.

Указанная последовательность действий позволяет во многом преодолеть фундаментально различие толкования и перевода. С одной стороны в словарной статье нашего словаря оказываются раскрытыми все значения японского слова, зафиксированные в толковых словарях, а с другой - общее число русских переводов часто не совпадает с числом толкований в толковых словарях.

Свободные словосочетания и выражения, приводимые в рубриках словарных статей, призваны полнее раскрыть значение слова и заполнить или подчеркнуть пробелы, возникающие из-за разницы между толкованием и переводом. Свободные словосочетания позволяют с точки зрения русского языка обосновать справедливость выделения данного значения слова, продемонстрировав на примере применимость указанного перевода на уровне синтагм. В некоторых случаях перевод свободного словосочетания указывает на возможность или даже необходимость использования альтернативных русских переводов, близких по значению к основным, но тем не менее не совпадающих с ними. Свободные словосочетания также во многих случаях используются для того, чтобы обратить внимание на различия в синтаксической сочетаемости японского заглавного слова в данном значении и его русского перевода. 

В отличии от свободных словосочетаний, устойчивые выражения во многих случаях помогают подчеркнуть разрывы между толкованием и переводом - при их переводе часто используются слова, сильно отличающиеся от тех, которые приведены в основных переводах рубрики.

Следует отметить, что описанный выше подход к разработке значений слов в настоящем словаре полностью соответствует принципам, сформулированным составителями БЯРС. Нами лишь уточнена последовательность действий при сопоставлении толкований и переводов.

# 3. СЛОВАРНАЯ СТАТЬЯ
Правила формирования структуры статьи и оформления различных ее элементов во многом совпадают с правилами, разработанными составителями БЯРС. Однако стоит отметить несколько основных отличия наших правил от правил БЯРС:

а) при оформлении заголовка в настоящем словаре не используются средства компактной записи - все компоненты даны целиком;

б) в заголовке статьи дается не только иероглифическое написание, но и написание каной;
...
Римскими цифрами в написании каной или в иероглифическом написании обозначаются варианты, являющиеся полными омограммами заголовков других статей. Полными омограммами называются такие слова, для которых совпадает написание каной и иероглифическое написание.
...
Простые и производные, как чисто японские слова, так и китайские заимствования (канго), пишутся слитно. В многосложных словах те их компоненты, которые являются полнозначными самостоятельными словами, отделяются в транскрипции дефисом.
...
### 3.5.5 Обозначение европейского v символом ヴ
Для заимствованных слов принята орфография, в которой, сохранен знак ヴ для передачи европейского *v*. В данном словаре даются ссылки с транскрипции начального *v* через *б* на транскрипцию через *в*.
...
## 3.9 Перевод
Перевод в подавляющем числе случаев является обязательным элементом рубрики и дается в ее первой строке.
...
В редких случаях переводы, имеющие общее пояснение (например, в виде стилистической пометы), могут объяединяться в группу при этом пояснении. Внутри такой группы переводы разделяются буквой со скобкой и точкой с запятой. 
...
### 3.9.3 Варианты перевода, введенные с помощью круглых скобок (`()`)
...
### 3.9.4 Факультативные части перевода, введенные с помощью квадратных скобок (`[]`)
...
При переводе сложных образных, переносных и связанных значений, особенно часто - пословиц и поговорок, в качестве пояснений в скобках дается буквальный перевод, обозначенный пометой `букв.`. 
...
Некоторые слова — к ним относятся многие названия специфических для Японии предметов одежды, блюд, предметов обихода и т. п. — непереводимы, и поэтому вместо перевода дается их транслитерация, сопровождающаяся пояснением.
...
Данные вместо перевода транслитерации японских слов в случае необходимости используются в составе пояснения при других словах. Следует иметь в виду, что все встречающиеся в переводах и в пояснениях транслитерированные японские слова даны в словаре в виде отдельных статей, где и приведено подробное их объяснение.

    すしや【鮨屋】(сусия)〔003-89-24〕
    1) ресторан, где подаётся су́си;
    2) повар, готовящий су́си.

### 3.9.9 Случаи отсутствие перевода
В редких случаях перевести заглавное слово не представляется возможным. В этом случае перевод опускается, а его место занимают пояснения, пометы, выражения, производные и т.п.
...
#### 3.9.9.2 Связанность употребления в словосочетаниях (`<i>связ.:</i>`) и ономатопоэтизмы (`<i>ономат.:</i>`)
...
#### 3.9.9.4 Замена перевода производным (`: ～する`, `: ～の` и .т.п.)
Перевод может быть опущен в случае, если слово представляет собой имя действия, свойства, состояния, способа действия и т.п., перевод которого эквивалентной частью речи либо затруднен и громоздок, либо вовсе невозможен. В этом случае первой строкой рубрики сразу дается производное, перевод которого облегчает понимание значения заглавного слова. При этом перед моделью производного (～する, ～の, ～に,
 ～てき и т.п.) ставится двоеточие и пробел. 
    ...
    : ～の зубчатый.
    ----
    Перевод "снабженность зубьями" является громоздким, а значение заглавного слова удобнее передать сразу через производное. 

#### 3.9.9.5 Пометы при опущенном перевода
...
В случае указания нескольких дополнительных написаний при помете *тж.* они разделяются запятыми.
    ...
    あいかた【相方】(аиката)〔002-73-98〕
    1) компаньон[ка];
    2) (<i>тж.</i> 敵娼) <i>прост.</i> моя девушка <i>(о проститутке)</i>.

    みち【道】(мити)〔004-88-96〕
    1) (<i>тж.</i> 路, 途) дорога, путь; проход; <i>тех.</i> траектория;
    <...>

В случае, если дополнительное написание указывается только для одного из переводов рубрики, разделенных точкой с запятой, помета *тж.* в скобках ставится непосредственно до или после этого перевода.
...
### 3.9.13 Сочетание исключительных и дополнительных написаний
...
### 3.9.14 Подстановочные ссылки (`см.`)
На месте всего перевода или любой его части, включая пояснения, может иметься ссылка на другую статью общего вида `<i>см.</i> <a href="#код статьи">заголовок статьи до транскрипции</a>`. Ссылка является формой компактной записи, позволяющая включить другую статью или ее часть в то место, где стоит ссылка.
...
#### 3.9.14.1 Оформление подстановочных ссылок
...
#### 3.9.14.2 Подстановочные ссылки на части статей
...
#### 3.9.14.3 Стилистические пометы при подстановочных ссылках (`уст. см`, `кн. см` и т.п.)
...
### 3.9.15 Отсылки (`ср.`)
С помощью пометы *ср.* в перевод вводится отсылка к другой статье, помогающая в раскрытии перевода. Оформление отсылки *ср.* производится по правилам, аналогичным подстановочной отсылке с пометой *см.*. В подавляющем числе случаев отсылки отделяется от перевода точкой с запятой. 
...
в) на слова с перечнями или шкалами, включающими слово, при котором стоит помета;
    ...
    ----
    しんど — степень силы землетрясения; при этом слове в скобках приведены семь слов, обозначающих, в порядке нарастания силы, семь ее градаций согласно традиционной японской шкале. Положение слова じゃくしん как третьего в этом ряду позволяет полнее представить себе относительную силу толчка, т.е. уточнить реальное значение этого слова.
...
### 3.9.17 Отсылка к полному варианту слова (`сокр.`)
Отсылка с помощью пометы *сокр.* используется в тех случаях, когда слово, при котором она стоит, является сокращением от того, на который дается отсылка. Оформление отсылки *сокр.* производится по правилам, аналогичным отсылке с пометой *ср.*.
...
### 3.9.19 Стилистические пометы (`кн.`, `разг.`, `эпист.` и др.)
...
### 3.9.20 Пометы, обозначающие специальные области (*бот.*, *мед.* и т. п.)
...
### 3.9.21 Заимствованные слова (`англ.`, `нем.` и т.п.)
...
### 3.9.22 Биологическая номенклатура
...
Многоточие *…* (U+2026, Horizontal Ellipsis) используется в модели производного для обозначения синтаксических валентностей. В переводе этим валентностям соответствуют неопределенные местоимения в соответствующих падежах (например, *чего-л.*, *кем-л.*), данные курсивом, или многоточия при соответствующих предлогах.
...
Часть модели, заключенная в круглые скобки (`()`), является вариантом предшествующего форманта или комплекса формантов. Такая запись может рассматриваться как форма компактной записи синонимичных вариантов через запятую.
...
В редких случаях факультативная часть может быть указана при отсутствии других формантов. В таких случаях это следует понимать как указание на то, что в данной рубрике перевод, указанный при производном слове, подходит и для заглавного слова тоже.
...
Перевод производного дается после модели и оформляется в соответствии с правилами, описанными в разделе 3.9. Таким образом, в переводе могут использоваться: разделение переводов запятыми и точкой с запятой, пояснения курсивом, пометы, круглые и квадратные скобки, подстановочные ссылки и отсылки и т.п.
...
Словосочетания и выражения в рубрике следуют в порядке увеличения связанности значения заглавного слова в них. 
...
Оформление выражение имеет двухчастную структуру `написание перевод`.

### 3.11.1 Написание выражения
Оформление написания выражения во многом аналогично оформлению модели производного (см. раздел 3.10.1). В нем могут использоваться следующие обозначения и способы компактной записи:
...
В отличии от моделей производных, в написании выражения заглавное слово не заменяется тильдой, а дается в иероглифическом написании или написании каной, зафиксированном в заголовке. Если в заголовке дано несколько иероглифических написаний, то, как правило, в выражениях используется наиболее употребительное из них.
...
Перевод выражения дается после его написания и оформляется в соответствии с правилами, описанными в разделе 3.9. Таким образом, в переводе могут использоваться разделение переводов запятыми и точкой с запятой, пояснения курсивом, пометы, круглые и квадратные скобки, подстановочные ссылки и отсылки и т.п.
...
Аналогично переводам производных (см. раздел 3.10.4) буквой со скобкой могут разделяться переводы выражения внутри группы при общем пояснении (чаще всего - помете). 
...
В конце рубрики, на отдельной строке могут даваться общие отсылки с пометой `ср.`. В отличие от отсылок в переводах (см. раздел 3.9.15), общие отсылки относятся ко всей рубрике целиком, включая все производные и выражения. Оформление общих отсылок аналогично описанному в разделе 3.9.15.
...
Общие отсылки не следует смешивать со случаями, когда отсылка с пометой `ср.` дается для последнего элемента рубрики (перевода, производного или выражения). В этом случае такая отсылка не отделяется переносом строки.

...
## 3.11 Свободные и фразеологические словосочетания, идимоматические выражения
Является необязательным разделом рубрики и чаще всего используется для для того, чтобы:
...
Далее следуют фразеологические словосочетания, являющиеся устойчивыми для слова в данном значении, и в которых его замена затруднена или невозможна. 

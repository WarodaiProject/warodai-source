...
Для заимствованных слов принята орфография, в которой, в частности, сохранен знак ヴ для передачи европейского *v* (такое написание в соответствующих словах дано и в словаре 広辞苑). Поэтому в данном словаре даются ссылки с транскрипции начального *v* через *б* на транскрипцию через *в*

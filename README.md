...
Для заимствованных слов принята орфография, в которой сохранён знак ヴ для передачи европейского *v*. В настоящем словаре даются ссылки с транскрипции начального *v* через *б* на транскрипцию через *в*.
...
Перевод может быть опущен в случае, если слово представляет собой имя действия, свойства, состояния, способа действия и т.п., перевод которого эквивалентной частью речи либо затруднен и громоздок, либо вовсе невозможен. В этом случае первой строкой рубрики сразу дается производное, перевод которого облегчает понимание значения заглавного слова. При этом перед моделью производного (～する, ～の, ～に, ～てき и т.п.) ставится двоеточие и пробел. 

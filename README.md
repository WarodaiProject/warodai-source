...
## 3.10 Производные
Производные - это самостоятельные слова и словосочетания, образованные от заглавного слова чаще всего с помощью следующих формантов: *ある*, *した*, *して*, *する*, *たる*, *的*, *で*, *と*, *な*,　*ない*, *なる*, *に, *の*, *やる*. Включение в статью таких производных является частным случаем гнездования, т.е. объединение в одной статье нескольких самостоятельных слов. 
...
Отдельным случаем псевдопроизводных следует считать именные прилагательные, которые помещаются в заголовке в форме основы, но переводятся в определительной форме, т.е. с такими формантами как *な*, *の*, *なる*, *たる*. Эти форманты не образуют самостоятельных слов, но образуют форму, удобную для русского перевода. Таким образом оформление таких случаев совпадает с оформлением самостоятельных производных, стоящих на месте перевода.  
...
Помимо форманта и заглавного слова, представленного тильдой, в модели часто включаются падежные показатели и другие служебные элементы.

...
- [3. СЛОВАРНАЯ СТАТЬЯ](#3-словарная-статья)
    ...
    - [3.9. Перевод](#39-перевод)
        ...
        - [3.9.13. Неверные дополнительные написания (`неправ.`)](#3913-неверные-дополнительные-написания-неправ)
...
### 3.9.13. Неверные дополнительные написания (`неправ.`)
Частным случаем указания дополнительного написания является приведение неправильного написания с пометой `неправ.`. Таким способом помечаются ошибочные иероглифические написания, получившие в языковой практике достаточно широкое распространение. В большинстве случаев такое написание относится ко всей статье целиком и даётся в общем пояснении.
...
Случаи с указанием неправильного написания не следует смешивать с произвольными отсылками к правильным вариантам слов, производных и выражений, также имеющих помету `неправ.`.

    かなう【叶う】(канау)〔003-62-11〕
    исполняться, осуществляться <i>(о надеждах, желаниях)</i>; быть услышанным <i>(напр. о молитве)</i>;
    <...>
    ◇身(力)に叶う (<i>неправ. вм.</i> <a href="#006-44-44">適う</a>) быть по силам <i>кому-л.</i>

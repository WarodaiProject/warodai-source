...
В простейшем случае статья содержит только одну рубрику, имеющую только один русский перевод. В этом случае рубрика никак не выделяется, а общее уточнение, если оно есть, следует непосредственно перед переводом.
...
Таким образом обязательными для статьи являются только заголовок и русский перевод для рубрики 1.
...
**Статья げきやく【激薬】(гэкияку)〔000-17-52〕**
<table>
    <tr>
        <td>
            げきやく【激薬】(гэкияку)〔000-17-52〕 
    ...
    <tr>
        ...
        <td>
            Общее уточнение. Рубрика 1. Перевод
        </td>
    </tr>
</table>

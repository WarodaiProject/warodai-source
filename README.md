...
Часто в одном переводе могут даваться группы разделенных *запятой* близких по значение переводов, которые в свою очередь разделенны *точкой с запятой*.
...
Часть перевода, заключенная в круглые скобки, является вариантом предшествующего слова или части словосочетания. Вариантность может относиться либо к форме выражения, т.е. выражаться синонимичными словами, либо к самому значению, т.е. выражаться словами однородными для данного контекста, но не синонимичных значений, например, «опрометчивое (необдуманное) решение» означает возможность двух синонимичных переводов: «опрометчивое решение» и «необдуманное решение»; «очаг, сделанный в земле (в полу)» означает возможность двух разных по смыслу переводов: «очаг, сделанный в земле» и «очаг, сделанный в полу».
...
*Курсивом* при переводе могут даваться дополнительные пояснения, помогающие раскрыть смысл перевода, но сами по себе в него не входящие. 
...
<pre>
<...>
筋道の立たない金はびた一文も出さない я не дам ни гроша на неоправданные расходы;
2) нить <i>(разговора и т. п.)</i>; должный порядок;
</pre>

Расстановка знаков препинания, в т.ч. скобок, при дополнительных пояснениях производится по правилам русского языка.
...
Некоторые слова — к ним относятся многие названия специфических для Японии предметов одежды, блюд, предметов обихода и т. п. — непереводимы, и поэтому вместо перевода дается их транслитерация, сопровождающаяся пояснением (курсивом). При этом в транслитерации указывается ударение, закрепившееся в таких словах в русском языке. 
...
В редких случаях перевести слово не представляется возможным по причине того, что оно является служебным элементом или гоноративом, для которых сложно подобрать эквивалент в русском языке. В этом случае в переводе имеется только пояснение курсивом　без круглых скобок. 
...
Следует обратить внимание, что в случае наличия выражений после такого пояснения часто ставится двоеточие, которое следует понимать как указание на некоторую степень связанность употребления слова. Таким образом данный случай оформления перевода сближается со случаем полного отсутствия перевода, обозначаемого пометой *связ.:* (см. §...).